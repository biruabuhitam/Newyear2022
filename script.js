...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('December 12, 2021 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["SELAMAT TAHUN BARU", " ", "Hai semua,enggak terasa ya udah tahun 2022 lagi", " ","Yuk kita Awali dengan Do'a", "<b>Alhamdulillah kita masih diberikan umur oleh Allah SWT untuk menginjak tahun baru</b>", "Bersyukurlah untuk tahun ini","","Bagi mereka yang saat ini masih tetap diberi kesehatan","","Bagi mereka yang masih mempunyai kedua orang tua lengkap dan masih diberi kesempatn untuk berbakti","", "bagi mereka yang tertawa dengan Anak cucu yang menemani","bagi mereka yang masih bersama dengan pasangan yang setia mendampingi", " ", "-Salam Dedi... :)"],
  startDelay: 4000,
  speed: 75,
